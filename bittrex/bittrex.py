...
class Bittrex(object):
    ...
    async def get_marketsummary(self, market):
        """
    ...
    async def withdraw(self, currency, quantity, address):
        """
    ...
    async def list_markets_by_currency(self, currency):
        """
    ...
    async def get_pending_withdrawls(self, currency=None):
        """
